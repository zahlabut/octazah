...
OctaviaGroup = [
    ...
    cfg.StrOpt('vip_ipv6_subnet2_cidr',
               default='fd06:1fd3:137::/64',
    ...
    cfg.StrOpt('member_1_ipv4_subnet2_cidr',
               default='10.4.1.0/24',
               help='CIDR format subnet to use for the 2nd member 1 subnet.'),
